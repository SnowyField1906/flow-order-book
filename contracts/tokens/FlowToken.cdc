...
pub contract FlowToken: FungibleToken {
    ...
    // Total supply of flowToken in existence
    ...
    pub resource Administrator {
        ...
        // transactions/flowToken/minter/setup_flowToken_minter.cdc
        // then the admin account running:
        // transactions/flowToken/admin/deposit_flowToken_minter.cdc
        //
    ...
    init() {
        ...
        self.MinterProxyPublicPath = /public/flowTokenMinterProxy
        self.MinterProxyStoragePath = /storage/flowTokenMinterProxy
