...
pub contract OrderBookVaultV12 {
  ...
  init() {
    ...
    self.TokenStoragePath = /storage/OrderBookVaultV12
    self.TokenPublicPath = /public/OrderBookVaultV12
